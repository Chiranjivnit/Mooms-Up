    ...
    return (
        <div className={classes.root}>
            ...
            >
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap>
                        Moms Up The Better Care for your Baby
            </Typography>
            ...
            >
                ...
                <Divider />
                <List>
                    {['Community'].map((text, index) => (
                        <ListItem button key={text}>
                            <Community>{index % 1 === 0 ? <InboxIcon /> : <Community />}</Community>
                            <ListItemText primary={text} />
                        </ListItem>
                    ))}
                ...
                <List>
                    {['Store'].map((text, index) => (
                        <ListItem button key={text}>
                            <Store>{index % 1 === 0 ? <InboxIcon /> : <Store />}</Store>
                            <ListItemText primary={text} />
                        </ListItem>
                    ))}
                ...
                <List>
                    {['Resourses'].map((text, index) => (
                        <ListItem button key={text}>
                            <Resourses>{index % 1 === 0 ? <InboxIcon /> : <Resourses />}</Resourses>
                            <ListItemText primary={text} />
                        </ListItem>
                    ))}
